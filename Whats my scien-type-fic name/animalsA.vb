Public Class animalsA
    ...
    Private Sub wait_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles wait.Tick
        ...
        Select Case ctr
            ...
            Case 2
                cobra.Show()
                clue.Text = "energy drink"
                number = 2
                wait.Enabled = False
                animation.Enabled = True
            Case 3
                camel.Show()
                clue.Text = "an animal with long eye lashes"
                number = 3
                wait.Enabled = False
                animation.Enabled = True
            Case 4
                cheetah.Show()
                clue.Text = "fastest animal on land"
                number = 4
                wait.Enabled = False
                animation.Enabled = True
            Case 5
                chimpanzee.Show()
                clue.Text = "a great ape; a kind of small African ape"
                number = 5
                wait.Enabled = False
                animation.Enabled = True
            Case 6
                crocodile.Show()
                clue.Text = "a slipper brand"
                number = 6
                wait.Enabled = False
                animation.Enabled = True
            Case 7
                chameleon.Show()
                clue.Text = "an animal that camouflage"
                number = 7
                wait.Enabled = False
                animation.Enabled = True
            Case 8
                dog.Show()
                clue.Text = "man's bestfriend"
                number = 8
                wait.Enabled = False
                animation.Enabled = True
            Case 9
            ...
            Case 10
                elephant.Show()
                clue.Text = "a cartoon character with a big ears that can make it fly"
                number = 10
                wait.Enabled = False
                animation.Enabled = True
            Case 11
                dolphin.Show()
                clue.Text = "a popular comedian actor + n"
                number = 11
                wait.Enabled = False
                animation.Enabled = True
            Case 12
                frog.Show()
                clue.Text = "Princess and the _______"
                number = 12
                wait.Enabled = False
                animation.Enabled = True
            Case 13
                fox.Show()
                clue.Text = "it says meng meng meng meng meng"
                number = 13
                wait.Enabled = False
                animation.Enabled = True
            Case 14
                giraffe.Show()
                clue.Text = "an animal with long neck"
                number = 14
                wait.Enabled = False
                animation.Enabled = True
            Case 15
                panda.Show()
                clue.Text = "an animal who can do Kung Fu"
                number = 15
                wait.Enabled = False
                animation.Enabled = True
            Case 16
                goat.Show()
                clue.Text = "represents the year 2003 "
                number = 16
                wait.Enabled = False
                animation.Enabled = True
            Case 17
                housefly.Show()
                clue.Text = "a common small fly occurring worldwide around human habitation"
                number = 17
                wait.Enabled = False
                animation.Enabled = True
            Case 18
                hippopotamus.Show()
                clue.Text = "large African animal that spends most of its time in water"
                number = 18
                wait.Enabled = False
                animation.Enabled = True
            Case 19
            ...
            Case 20
                kangaroo.Show()
                clue.Text = "hopping and leaping animal"
                number = 20
                wait.Enabled = False
                animation.Enabled = True
            Case 21
                lion.Show()
                clue.Text = "King of the Jungle"
                number = 21
                wait.Enabled = False
                animation.Enabled = True
            Case 22
                lizard.Show()
                clue.Text = "a reptile where tails grew even when cut"
                number = 22
                wait.Enabled = False
                animation.Enabled = True
            Case 23
                mouse.Show()
                clue.Text = "a computer accesory"
                number = 23
                wait.Enabled = False
                animation.Enabled = True
            Case 24
                panther.Show()
                clue.Text = "One of the Marvel's Movie"
                number = 24
                wait.Enabled = False
                animation.Enabled = True
            Case 25
                rabbit.Show()
                clue.Text = "an animal with long ears and puffy body"
                number = 25
                wait.Enabled = False
                animation.Enabled = True
            Case 26
                squirrel.Show()
                clue.Text = "an animal that loves nuts"
                number = 26
                wait.Enabled = False
                animation.Enabled = True
            Case 27
                tiger.Show()
                clue.Text = "orange and black striped animal"
                number = 27
                wait.Enabled = False
                animation.Enabled = True
            Case 28
                zebra.Show()
                clue.Text = "black and white striped animal"
                number = 28
                wait.Enabled = False
                animation.Enabled = True
            Case 29
                buffalo.Show()
                clue.Text = "an animal when cooked has wings"
                number = 29
                wait.Enabled = False
                animation.Enabled = True
            Case 30
                bluewhale.Show()
                clue.Text = "largest living mammal on water"
                number = 30
                wait.Enabled = False
                animation.Enabled = True
            Case 31
            ...
            Case 33
                wolf.Show()
                clue.Text = "wild animal that looks like a large dog"
                number = 33
                wait.Enabled = False
                animation.Enabled = True
            Case 34
                jaguar.Show()
                clue.Text = "one of the characters in a TV series 'Wild Flower'"
                number = 34
                wait.Enabled = False
                animation.Enabled = True
            Case 35
                iguana.Show()
                clue.Text = "Already have in English"
                number = 35
                wait.Enabled = False
                animation.Enabled = True
            Case 36
                leopard.Show()
                clue.Text = "D R A P O E L"
                number = 36
                wait.Enabled = False
                animation.Enabled = True
            Case 37
                ostrich.Show()
                clue.Text = "largest living bird; fastest animal on two legs"
                number = 37
                wait.Enabled = False
                animation.Enabled = True
            Case 38
                polarbear.Show()
                clue.Text = "large white bear found near the North Pole"
                number = 38
                wait.Enabled = False
                animation.Enabled = True
            Case 39
                sparrow.Show()
                clue.Text = "Surname of Captain Jack"
                number = 39
                wait.Enabled = False
                animation.Enabled = True
            Case 40
                tarantula.Show()
                clue.Text = "taran + ‘poem’"
                number = 40
                wait.Enabled = False
                animation.Enabled = True
            Case 41
                tasmaniandevil.Show()
                clue.Text = "meat-eating mammal found in Tasmania"
                number = 41
                wait.Enabled = False
                animation.Enabled = True
            Case 42
                wildcat.Show()
                clue.Text = "a cat which is very fierce that lives in mountains or forests"
                number = 42
                wait.Enabled = False
                animation.Enabled = True
            Case 43
                peacock.Show()
                clue.Text = "shiny blue bird who fans out its colorful tail feathers; one of the songs of Katy Perry"
                number = 43
                wait.Enabled = False
                animation.Enabled = True
            Case 44
                pigeon.Show()
                clue.Text = "a bird called by clapping"
                number = 44
                wait.Enabled = False
                animation.Enabled = True
            Case 45
                arabiancamel.Show()
                clue.Text = "known as Dromedary camel; large one-humped camel"
                number = 45
                wait.Enabled = False
                animation.Enabled = True
            Case 46
                houselizard.Show()
                clue.Text = "a reptile that always seen in the ceiling/wall of the house"
                number = 46
                wait.Enabled = False
                animation.Enabled = True
            Case 47
                blackrat.Show()
                clue.Text = "color) + homonym of 'rot'"
                number = 47
                wait.Enabled = False
                animation.Enabled = True
            Case 48
                snakesea.Show()
                clue.Text = "a long reptile that lived under the sea usually called 'walo walo'"
                number = 48
                wait.Enabled = False
                animation.Enabled = True
            Case 49
                hyena.Show()
                clue.Text = "The antagonist in 'The Lion King'"
                number = 49
                wait.Enabled = False
                animation.Enabled = True
            Case 50
                porcupine.Show()
                clue.Text = "large rodent that uses their spines or quills to defense themselves"
                number = 50
                wait.Enabled = False
                animation.Enabled = True
            Case 51
                rhinoceros.Show()
                clue.Text = "rain + o + serious"
                number = 51
                wait.Enabled = False
                animation.Enabled = True
            Case 52
                scorpion.Show()
                clue.Text = "The ______________ King"
                number = 52
                wait.Enabled = False
                animation.Enabled = True
            Case 53
                seahorse.Show()
                clue.Text = "a horse that lived under the sea"
                number = 53
                wait.Enabled = False
                animation.Enabled = True
