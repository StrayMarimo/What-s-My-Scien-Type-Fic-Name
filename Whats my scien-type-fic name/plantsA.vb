Public Class plantsA
    ...
    Private Sub go_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles go.Click
        ...
        ctr = rn.Next(1, 64) 'randomize scinames
        wait.Enabled = True
    ...
    Private Sub wait_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles wait.Tick
        ...
        Select Case ctr
            ...
            Case 2
                banana.Show()
                CLUE.Text = "favorite fruit of the Minions"
                number = 2
                wait.Enabled = False
                animation.Enabled = True
            Case 3
                guava.Show()
                CLUE.Text = "a small, green, round sweet but sour fruit"
                number = 3
                wait.Enabled = False
                animation.Enabled = True
            Case 4
                mango.Show()
                CLUE.Text = "green when unripe, yellow when ripe"
                number = 4
                wait.Enabled = False
                animation.Enabled = True
            Case 5
                lemon.Show()
                CLUE.Text = "a yellow citrus fruit usually drink as juice"
                number = 5
                wait.Enabled = False
                animation.Enabled = True
            Case 6
                potato.Show()
                CLUE.Text = "main ingredient of fries"
                number = 6
                wait.Enabled = False
                animation.Enabled = True
            Case 7
                ginger.Show()
                CLUE.Text = "drank by singers with water"
                number = 7
                wait.Enabled = False
                animation.Enabled = True
            Case 8
                rice.Show()
                CLUE.Text = "when you go up, you _ _ _ _ "
                number = 8
                wait.Enabled = False
                animation.Enabled = True
            Case 9
                bamboo.Show()
                CLUE.Text = "a rock singer"
                number = 9
                wait.Enabled = False
                animation.Enabled = True
            Case 10
                orange.Show()
                CLUE.Text = "a fruit named after its color"
                number = 10
                wait.Enabled = False
                animation.Enabled = True
            Case 11
                cucumber.Show()
                CLUE.Text = "a vegetable that is put in closed eyes to reduce eye stress"
                number = 11
                wait.Enabled = False
                animation.Enabled = True
            Case 12
                eggplant.Show()
                CLUE.Text = "poultry plant"
                number = 12
                wait.Enabled = False
                animation.Enabled = True
            Case 13
                pineapple.Show()
                CLUE.Text = "an apple with pine"
                number = 13
                wait.Enabled = False
                animation.Enabled = True
            Case 14
                starapple.Show()
                CLUE.Text = "a heart but a star"
                number = 14
                wait.Enabled = False
                animation.Enabled = True
            Case 15
            ...
            Case 16
                watermelon.Show()
                CLUE.Text = "a fruit that contains 90% water"
                number = 16
                wait.Enabled = False
                animation.Enabled = True
            Case 17
                blackpepper.Show()
                CLUE.Text = "a dark spice"
                number = 17
                wait.Enabled = False
                animation.Enabled = True
            Case 18
            ...
            Case 19
                ...
                wait.Enabled = False
                animation.Enabled = True
                CLUE.Text = "either red or white that has a spicy flavor looks like carrots"
            Case 20
                spinach.Show()
                CLUE.Text = "a green leaf plant"
                number = 20
                wait.Enabled = False
                animation.Enabled = True
            Case 21
                staranise.Show()
                CLUE.Text = "a star-like spice"
                number = 21
                wait.Enabled = False
                animation.Enabled = True
            Case 22
                sweetpotato.Show()
                CLUE.Text = "a potato with sugar"
                number = 22
                wait.Enabled = False
                animation.Enabled = True
            Case 23
                blueberry.Show()
                CLUE.Text = "a berry like a deep ocean"
                number = 23
                wait.Enabled = False
                animation.Enabled = True
            Case 24
            ...
            Case 25
                capsicum.Show()
                CLUE.Text = "cap + c + comb"
                number = 25
                wait.Enabled = False
                animation.Enabled = True
            Case 26
                cashewnut.Show()
                CLUE.Text = "kernel fruit of cashew"
                number = 26
                wait.Enabled = False
                animation.Enabled = True
            Case 27
                cherry.Show()
                CLUE.Text = "an actress and her surname is Gil"
                number = 27
                wait.Enabled = False
                animation.Enabled = True
            Case 28
                chiku.Show()
                CLUE.Text = "elbow in tagalog"
                number = 28
                wait.Enabled = False
                animation.Enabled = True
            Case 29
            ...
            Case 30
                clove.Show()
                CLUE.Text = "sounds like glove"
                number = 30
                wait.Enabled = False
                animation.Enabled = True
            Case 31
                coriander.Show()
                CLUE.Text = "core + under"
                number = 31
                wait.Enabled = False
                animation.Enabled = True
            Case 32
                cotton.Show()
                CLUE.Text = "a soft and cloud-like product"
                number = 32
                wait.Enabled = False
                animation.Enabled = True
            Case 33
                dewberry.Show()
                CLUE.Text = "a cracker will fillings"
                number = 33
                wait.Enabled = False
                animation.Enabled = True
            Case 34
                durian.Show()
                CLUE.Text = "a fruit that is famous and rich in Davao"
                number = 34
                wait.Enabled = False
                animation.Enabled = True
            Case 35
                fuchsia.Show()
                CLUE.Text = "a pink color"
                number = 35
                wait.Enabled = False
                animation.Enabled = True
            Case 36
            ...
            Case 37
                ivy.Show()
                CLUE.Text = "protagonists in 'Wildflower'"
                number = 37
                wait.Enabled = False
                animation.Enabled = True
            Case 38
                jackfruit.Show()
                CLUE.Text = "a fruit and the brother of Jill"
                number = 38
                wait.Enabled = False
                animation.Enabled = True
            Case 39
                jasmine.Show()
                CLUE.Text = "a disney princess"
                number = 39
                wait.Enabled = False
                animation.Enabled = True
            Case 40
                laurel.Show()
                CLUE.Text = "a leaf that is seen in Francisco Balagtas' hair"
                number = 40
                wait.Enabled = False
                animation.Enabled = True
            Case 41
                lilac.Show()
                CLUE.Text = "a flower named after its color near violet"
                number = 41
                wait.Enabled = False
                animation.Enabled = True
            Case 42
                malunggay.Show()
                CLUE.Text = "a leafy vegetable and a main ingedient in pandesal"
                number = 42
                wait.Enabled = False
                animation.Enabled = True
            Case 43
            ...
            Case 44
                oak.Show()
                CLUE.Text = "tie a yellow ribbon roung the old _____tree"
                number = 44
                wait.Enabled = False
                animation.Enabled = True
            Case 45
                olive.Show()
                CLUE.Text = "a small round green or black fruit, seen in overload pizza"
                number = 45
                wait.Enabled = False
                animation.Enabled = True
            Case 46
                papaya.Show()
                CLUE.Text = "usually used as whitening ingredient in beauty soaps"
                number = 46
                wait.Enabled = False
                animation.Enabled = True
            Case 47
                pea.Show()
                CLUE.Text = "rhymes with pee"
                number = 47
                wait.Enabled = False
                animation.Enabled = True
            Case 48
                peach.Show()
                CLUE.Text = "a fruit that is named after its color"
                number = 48
                wait.Enabled = False
                animation.Enabled = True
            Case 49
            ...
            Case 50
                pear.Show()
                CLUE.Text = "a______ disa________ one half one fourth"
                number = 50
                wait.Enabled = False
                animation.Enabled = True
            Case 51
                pine.Show()
                CLUE.Text = "when Filipinos read 'fine'"
                number = 51
                wait.Enabled = False
                animation.Enabled = True
            Case 52
                poisonivy.Show()
                CLUE.Text = "a poisonous flower"
                number = 52
                wait.Enabled = False
                animation.Enabled = True
            Case 53
                raspberry.Show()
                CLUE.Text = "a red berry"
                number = 53
                wait.Enabled = False
                animation.Enabled = True
            Case 54
                rosemary.Show()
                CLUE.Text = "rosa + maria"
                number = 54
                wait.Enabled = False
                animation.Enabled = True
            Case 55
                soyabean.Show()
                CLUE.Text = "an ingredient in vitamilk"
                number = 55
                wait.Enabled = False
                animation.Enabled = True
            Case 56
                strawberry.Show()
                CLUE.Text = "a thing used to sip + bee + ray"
                number = 56
                wait.Enabled = False
                animation.Enabled = True
            Case 57
                sunflower.Show()
                CLUE.Text = "a tall yellow plant worn by jejes"
                number = 57
                wait.Enabled = False
                animation.Enabled = True
            Case 58
                tamarind.Show()
                CLUE.Text = "a sour fruit best with sugar, used as spice in sinigang"
                number = 58
                wait.Enabled = False
                animation.Enabled = True
            Case 59
                tawatawa.Show()
                CLUE.Text = "laugh laugh"
                number = 59
                wait.Enabled = False
                animation.Enabled = True
            Case 60
                tea.Show()
                CLUE.Text = "a hot drink"
                number = 60
                wait.Enabled = False
                animation.Enabled = True
            Case 61
            ...
            Case 63
                walnut.Show()
                CLUE.Text = "a nut and a wall"
                number = 63
                wait.Enabled = False
                animation.Enabled = True
            Case 64
                wheat.Show()
                CLUE.Text = "you say this when you holdback or hold up"
                number = 64
                wait.Enabled = False
                animation.Enabled = True
